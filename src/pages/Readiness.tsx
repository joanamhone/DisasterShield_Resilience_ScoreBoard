...
import {
  ...
  ReadinessResponse,
  AssessmentAnswer,
} from "../contexts/ReadinessContext";
...
const Readiness: React.FC = () => {
  ...
  const [currentStep, setCurrentStep] = useState<
    "choice" | "quiz" | "results" | "history-detail"
  >("choice");
  const [quizType, setQuizType] = useState<"general" | "school" | "community">(
    "general"
  );
  ...
  const handleAssessmentChoice = (
    type: "general" | "school" | "community" = "general"
  ) => {
    setQuizType(type);
    setCurrentStep("quiz");
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            ...
            <p className="text-text-secondary text-sm leading-relaxed">
              For Individuals & Families. Evaluate how prepared you and your
              household are.
            </p>
