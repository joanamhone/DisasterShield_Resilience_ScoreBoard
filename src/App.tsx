...
import { DisasterPredictionProvider } from './contexts/DisasterPredictionContext'; // 1. Import the new provider
...
function App() {
  return (
    <AuthProvider>
      <ReadinessProvider>
        {/* 2. Wrap your Router with the DisasterPredictionProvider */}
